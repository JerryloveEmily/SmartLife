 ...
 */
public class JSlidingPaneLayout extends ViewGroup {
    ...
    public JSlidingPaneLayout(Context context) {
        this(context, null);
    }

    public JSlidingPaneLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JSlidingPaneLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(JSlidingPaneLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(JSlidingPaneLayout parent, View child) {
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == JSlidingPaneLayout.this) {
